...
class CreateVeoDto(BaseSchema):
  ...
  def validate_video_aspect_ratio(cls, value: AspectRatioEnum) -> AspectRatioEnum:
      ...
      if value not in valid_video_ratios:
          raise ValueError("Invalid aspect ratio for video. Only '16:9' and '9:16' are supported.")
      return value

  @field_validator('generation_model')
  def validate_video_generation_model(cls, value: GenerationModelEnum) -> GenerationModelEnum:
